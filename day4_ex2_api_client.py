...
class CarrierAPIClient:
    """
    HTTP client for the carrier tracking API. Supports context manager usage:
    ...
    def __init__(self, base_url: str, api_key: str) -> None:
        ...
        self._api_key = api_key  # Private — never log this
    ...
    def _handle_status(self, url: str, status_code: int, body: str) -> dict:
        """
        Route HTTP status codes to exceptions or return parsed body. Rules:
...
if __name__ == "__main__":
    ...
    try:
        client.get_shipments("2024-01-20")  # Outside with block

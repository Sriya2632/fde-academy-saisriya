...
Parses a nested (mock) weather API response, validates it with Pydantic,
and flattens it into a dashboard-ready schema.
"""
...
def build_dashboard_panel(cities: list[str]) -> list[DashboardWeatherRecord]:
    ...
    for city in cities:
        try:
            ...
            panel.append(transform_weather_to_dashboard(raw))
